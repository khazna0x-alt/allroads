export const brand = {
  ...
  email: "contact@allroads.om",
  whatsapp: "https://api.whatsapp.com/send?phone=96897544534",
  ...
  mapsEmbed:
    "https://maps.google.com/maps?q=All+roads+Car+Showroom,+next+to+lulu+al+amirat,+Al+Amerat&output=embed",
  locationAr: "العامرات، بجوار لولو هايبر ماركت",
  locationEn: "Al Amerat, next to Lulu Hypermarket",
  cityAr: "محافظة مسقط، سلطنة عُمان",
  cityEn: "Muscat Governorate, Sultanate of Oman",
  addressAr: "العامرات، بجوار لولو هايبر ماركت، محافظة مسقط، سلطنة عُمان",
  addressEn: "Al Amerat, next to Lulu Hypermarket, Muscat Governorate, Sultanate of Oman",
